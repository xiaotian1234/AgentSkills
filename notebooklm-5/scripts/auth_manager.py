...
class AuthManager:
    ...
    def setup_auth(self, headless: bool = False, timeout_minutes: int = 10) -> bool:
        ...
        try:
            ...
            try:
                ...
                print(f"  [X] Authentication timeout: {e}")
                return False
    ...
    def _save_browser_state(self, context: BrowserContext):
        ...
        try:
            ...
            print(f"  [X] Failed to save browser state: {e}")
            raise
    ...
    def clear_auth(self) -> bool:
        ...
        """
        print("[DEL] Clearing authentication data...")
        ...
        try:
            ...
            print(f"  [X] Error clearing auth: {e}")
            return False
    ...
    def re_auth(self, headless: bool = False, timeout_minutes: int = 10) -> bool:
        ...
        Returns:
            True if successful
        """
        print("[REFRESH] Starting re-authentication...")
    ...
    def validate_auth(self) -> bool:
        ...
        print("[SEARCH] Validating authentication...")
        ...
        try:
            ...
            if "notebooklm.google.com" in page.url and "accounts.google.com" not in page.url:
                ...
                print("  [X] Authentication is invalid (redirected to login)")
                return False
