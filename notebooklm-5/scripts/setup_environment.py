...
class SkillEnvironment:
    ...
    def ensure_venv(self) -> bool:
        ...
        if self.requirements_file.exists():
            ...
            try:
                ...
                print("[WEB] Installing Google Chrome for Patchright...")
                try:
                    subprocess.run(
    ...
    def run_script(self, script_name: str, args: list = None) -> int:
        ...
        if not self.ensure_venv():
            print("[X] Failed to set up environment")
            return 1
        ...
        try:
            ...
            print(f"[X] Failed to run script: {e}")
            return 1
...
def main():
    ...
    if args.check:
        if env.venv_dir.exists():
            ...
            print(f"[X] No virtual environment found")
