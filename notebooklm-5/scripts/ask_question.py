...
def ask_notebooklm(question: str, notebook_url: str, headless: bool = True) -> str:
    ...
    print(f"[BOOK] Notebook: {notebook_url}")
    ...
    try:
        ...
        if not query_element:
            print("  [X] Could not find query input")
            return None
...
def main():
    ...
    if not notebook_url:
        ...
        if active:
            ...
            print(f"[BOOK] Using active notebook: {active['name']}")
        else:
            # Show available notebooks
            notebooks = library.list_notebooks()
            if notebooks:
                print("\n[BOOK] Available notebooks:")
                for nb in notebooks:
                ...
                print("[X] No notebooks in library. Add one first:")
